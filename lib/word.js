...
const BASE_COLOR = new Color(256,256,180);
const HIGHLIGHT_COLOR = new Color(256,256,256);
console.log(BASE_COLOR.toString());
const NEW_COLOR = new Color(100, 256, 100);
...
class Word{
  constructor(text, x, y, ctx, vel = {x: 0, y: 0}){
    ...
    this.fade = setInterval(()=>{
      ...
      this.color = NEW_COLOR.mix(this.baseColor, i);
      i += .01;
    }, 40);
  }
